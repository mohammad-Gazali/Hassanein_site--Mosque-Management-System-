...
class Level(models.Model):
    ...
    specialization = models.ForeignKey(
        Specialization, verbose_name="الاختصاص", on_delete=models.CASCADE
    )
...
class Part(models.Model):
    ...
    students = models.ManyToManyField(
        Student, verbose_name="الطلاب الذين أنهوا القسم", blank=True
    )
...
class SpecializationMessage(models.Model):
    student = models.ForeignKey(
        Student, verbose_name="الطالب", on_delete=models.CASCADE
    )
    master_name = models.ForeignKey(
        Master, verbose_name="الأستاذ", on_delete=models.CASCADE
    )
