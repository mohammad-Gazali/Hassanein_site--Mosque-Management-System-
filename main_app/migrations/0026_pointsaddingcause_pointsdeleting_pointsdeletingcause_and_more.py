...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('main_app', '0025_pointsadding_master_name_pointsdeletings_master_name_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='cause',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main_app.pointsdeletingcause', verbose_name='السبب'),
        ),
        migrations.AddField(
            model_name='pointsdeleting',
            name='master_name',
        ...
        migrations.AddField(
            ...
            name='cause',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='main_app.pointsaddingcause', verbose_name='السبب'),
        ),
    ]
