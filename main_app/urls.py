...
urlpatterns = [
    ...
    path("points/delete/add/admin/<int:aid>", views.deleting_editing_points_add_admin, name="editing_points_delete_add_admin"),
    path("points/delete/remove/admin/<int:rid>", views.deleting_editing_points_remove_admin, name="editing_points_delete_remove_admin"),
